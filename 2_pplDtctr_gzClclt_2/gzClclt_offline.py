...
# 1. 读取原始数据
df = pd.read_csv("eye_dataset_qt/session_20250521_165509_5p/raw_eye_data.csv")
print(df)
...
print(f"Saved best model '{best_model_name}' to {model_path} with RMSE: {results[best_model_name]['rmse']:.2f}")
